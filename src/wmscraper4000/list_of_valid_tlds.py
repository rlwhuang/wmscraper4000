# Generic top-level domains (gTLDs and sTLDs) valid up to 2005
gtlds_1995_2005 = [
    # Legacy
    "com", "net", "org", "edu", "gov", "mil", "int",
    # New batch from 2000–2001
    "aero", "biz", "coop", "info", "museum", "name", "pro"
]

# Country code top-level domains (ccTLDs) delegated by 2005
cctlds_1995_2005 = [
    ...
    "th","tj","tk","tl","tm","tn","to","tp","tr","tt","tv","tw","tz","ua","ug","uk",
    "um","us","uy","uz","va","vc","ve","vg","vi","vn","vu","wf","ws","ye","yt","yu",
    "za","zm","zw"
]

list_of_valid_tlds = set(gtlds_1995_2005 + cctlds_1995_2005)
